...
import com.oracle.datagrid.NoSQL.*;
 ...
 */
public class NoSQLScratchPad {

    public static KVStore store;
    public static AvroCatalog catalog;
    public static SpecificAvroBinding<Customer> binding;
    ...
    public static void main(String args[]) {
        ...
        Key key = Key.createKey(Arrays.asList("cust", "0000000004"));

        /* Read the value we previous stored, if any. */
        Customer customer;
        customer = createCustomer();
        store.put(key, binding.toValue(customer));
        ValueVersion value = store.get(key);
        customer = binding.toObject(value.getValue());
    ...
    public static Customer createCustomer() {
        ...
        name.setFirstName("Remy");
        name.setLastName("Martian");
